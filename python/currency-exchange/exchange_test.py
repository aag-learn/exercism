...
class CurrencyExchangeTest(unittest.TestCase):
    ...
    def test_get_value_of_bills(self):
        test_data = [(10000, 128), (50, 360), (200, 200), (15.13, 16)]
        result_data = [1280000, 18000, 40000, 242]
    ...
    def test_get_number_of_bills(self):
        test_data = [(163270, 50000), (54361, 1000), (127.5,5), (35.16, 10)]
        result_data = [3, 54, 25, 3]
    ...
    def test_get_leftover_of_bills(self):
        test_data = [(10.1, 10), (654321.0, 5), (3.14, 2), (127.5,20), (153.2, 10)]
        result_data = [0.1, 1.0, 1.14, 7.5, 3.20]
